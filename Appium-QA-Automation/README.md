...
This project is a fork of [AppiumQA-Automation](https://github.com/DSrijon01/AppiumQA-Automation) by [DSrijon01](https://github.com/DSrijon01). It has been modified to suit the specific needs of our project. The original project is licensed under the MIT License.
